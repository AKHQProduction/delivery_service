...
class SQLAlchemyRecurringOrderReadGateway:
    ...
    def _apply_filters(
        ...
        if filters.client_id:
            query = query.where(RecurringOrder.client_id == filters.client_id)
    ...
    def _to_read_model(
        ...
        *,
        ...
        time_slot: ShopDeliveryTimeSlot | None,
        items_count: int,
    ) -> RecurringOrderReadModel:
        return RecurringOrderReadModel(
            ...
            time_slot_label=time_slot.label if time_slot else None,
