...
export const ShopSettingsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pb-32 md:from-white md:to-white md:pb-8">
      <PageHeader title="Налаштування магазину" />

      <div className="px-4 sm:px-6 py-6 space-y-6 md:px-8">
