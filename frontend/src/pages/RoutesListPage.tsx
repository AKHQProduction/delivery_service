...
import { MapPicker, type MapConfirmData } from "../components/shared/MapPicker";
...
export const RoutesListPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-gray-100 md:from-white md:to-white">
                ...
                <div className="px-5 py-4 bg-amber-50 border-b border-amber-100 flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 text-sm">
                      Без координат ({routePlan.unroutable_orders.length})
                    </h4>
                ...
                <div className="divide-y divide-gray-100">
                  {routePlan.unroutable_orders.map((order) => (
                    <div key={order.order_id} className="px-5 py-3 flex items-center gap-3">
                      ...
                      <button
                        type="button"
                        onClick={() => handleSetAddress(order)}
      ...
      <MapPicker
        isOpen={isMapOpen}
        onClose={() => { closeMap(); setEditingOrder(null); }}
