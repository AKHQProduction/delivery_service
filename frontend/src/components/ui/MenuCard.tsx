...
export const MenuCard: React.FC<MenuCardProps> = ({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group relative bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 p-6 text-left border border-gray-100 overflow-hidden"
    >
      ...
      <div className="relative flex items-center gap-5">
        ...
        <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
          <img
            src={icon}
            alt={label}
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-xl font-bold text-gray-900 mb-1.5 group-hover:text-indigo-600 transition-colors">
            {label}
          </h3>
